...
// * First compile the server.c file and run using this format : 
// ./server portnumber(any range except 0-1023)
// * Then compile the client.c file and run using this format : 
// ./client 127.0.0.1  portnumber(same as written on server side)
